...
import example.micronaut.services.condictions.SendGridEmailCondition
...
class SendGridEmailService(
    @Value("\${SENDGRID_API_KEY:none}") apiKeyEnv: String,
    @Value("\${SENDGRID_FROM_EMAIL:none}") fromEmailEnv: String,
    @Value("\${sendgrid.apikey:none}") apiKeyProp: String,
    @Value("\${sendgrid.fromemail:none}") fromEmailProp: String
) : MailService {
