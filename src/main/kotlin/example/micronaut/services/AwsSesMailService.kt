...
import example.micronaut.services.condictions.AwsSesMailCondition
...
class AwsSesMailService(
    @Value("\${AWS_REGION:none}") awsRegionEnv: String,
    ...
    private val awsCredentialsProviderService: AwsCredentialsProviderService?
) : MailService {
